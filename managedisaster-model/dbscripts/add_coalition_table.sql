...
ALLOCATED_BUILDING_ID int comment 'Allocated Burning Building id. ref: Building',
...
constraint COALITION_BUILD_FK foreign key (ALLOCATED_BUILDING_ID) references BUILDING(ID)
)
